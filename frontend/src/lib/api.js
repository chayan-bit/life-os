...
export const API_ROUTES = [
  ...
  },
  {
    ...
    path: '/api/annotation',
    status: 'live',
    summary: 'Create a workspace-scoped note/highlight/question/comment/link on an entity.',
    sample: { entity_id: 'topic-sockets', kind: 'comment', body: 'great point', anchor: { type: 'selection', quote: 'BSD sockets' } },
  },
  {
    service: 'lifeos-api',
    method: 'GET',
    path: '/api/annotation',
    status: 'live',
    summary: 'List annotations, filterable by entity_id and/or kind (workspace-scoped).',
    sample: null,
  },
  {
    service: 'lifeos-api',
    method: 'PATCH',
    path: '/api/annotation/:id',
    status: 'live',
    summary: 'Update an annotation body/kind/anchor/attrs. Emits an annotation.updated event.',
    sample: { body: 'edited note' },
  },
  {
    service: 'lifeos-api',
    method: 'DELETE',
    path: '/api/annotation/:id',
    status: 'live',
    summary: 'Delete an annotation (workspace-scoped). Emits an annotation.deleted event.',
    sample: null,
  },
  {
    service: 'lifeos-api',
  ...
  },
  {
    ...
    path: '/api/approvals',
    status: 'live',
    summary: 'List entities awaiting a human decision (drafts, build gates, storage switches).',
    sample: null,
  },
  {
    service: 'lifeos-api',
    method: 'POST',
    path: '/api/approval/:id/approve',
    status: 'live',
    summary: 'Approve a pending action (CAS + execute_approval job). T5 gates require { typed } matching the node name.',
    sample: { typed: 'my-node' },
  },
  {
    service: 'lifeos-api',
    method: 'POST',
    path: '/api/approval/:id/deny',
    status: 'live',
    summary: 'Deny a pending action (CAS to rejected, no job enqueued).',
    sample: null,
  },
  {
    service: 'lifeos-api',
